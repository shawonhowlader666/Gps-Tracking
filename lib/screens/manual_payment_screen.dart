...
class _ManualPaymentScreenState extends State<ManualPaymentScreen>
  ...
  Future<void> _captureAndShare() async {
    ...
    try {
      ...
      final String packageStr = widget.packageTitle != null && widget.packageTitle!.isNotEmpty
          ? widget.packageTitle!.replaceAll('\n', ' ')
          : (widget.packageType != null && widget.packageType!.isNotEmpty
              ? '${widget.packageType} (BDT ${widget.dueAmount})'
              : 'Bill Payment (BDT ${widget.dueAmount})');
      ...
      // Launch WhatsApp directly to bypass the system share sheet
...
class _BanglaQrCard extends StatelessWidget {
  const _BanglaQrCard();
            ...
            Container(
              ...
              child: const Row(
                children: [
                  ...
                  SizedBox(width: 8),
                  Text(
                    'স্ক্যান করে পেমেন্ট করুন (Bangla QR)',
                    style: TextStyle(
                      color: Colors.white,
                      fontSize: 13,
                ...
                children: [
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        const Text(
                          'বিকাশ, নগদ, রকেট বা যেকোনো ব্যাংক অ্যাপ দিয়ে কিউআর স্ক্যান করে পেমেন্ট করুন।',
                          style: TextStyle(
                            fontSize: 12,
                            fontWeight: FontWeight.w600,
